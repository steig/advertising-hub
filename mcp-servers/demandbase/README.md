...
2. Implement auth using `core/auth/demandbase.py`
...
- Platform config: `platforms/demandbase/PLATFORM.yaml`
- Auth patterns: `platforms/demandbase/patterns/`
- Upstream repos: `platforms/demandbase/README.md`
