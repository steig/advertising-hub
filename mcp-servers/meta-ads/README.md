...
2. Implement auth using `core/auth/meta-ads.py`
...
- Platform config: `platforms/meta-ads/PLATFORM.yaml`
- Auth patterns: `platforms/meta-ads/patterns/`
- Upstream repos: `platforms/meta-ads/README.md`
