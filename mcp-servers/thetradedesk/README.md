...
2. Implement auth using `core/auth/thetradedesk.py`
...
- Platform config: `platforms/thetradedesk/PLATFORM.yaml`
- Auth patterns: `platforms/thetradedesk/patterns/`
- Upstream repos: `platforms/thetradedesk/README.md`
