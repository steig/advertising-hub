...
2. Implement auth using `core/auth/pinterest-ads.py`
...
- Platform config: `platforms/pinterest-ads/PLATFORM.yaml`
- Auth patterns: `platforms/pinterest-ads/patterns/`
- Upstream repos: `platforms/pinterest-ads/README.md`
