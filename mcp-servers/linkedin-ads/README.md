...
2. Implement auth using `core/auth/linkedin-ads.py`
...
- Platform config: `platforms/linkedin-ads/PLATFORM.yaml`
- Auth patterns: `platforms/linkedin-ads/patterns/`
- Upstream repos: `platforms/linkedin-ads/README.md`
