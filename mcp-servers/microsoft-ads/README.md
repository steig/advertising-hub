...
2. Implement auth using `core/auth/microsoft-ads.py`
...
- Platform config: `platforms/microsoft-ads/PLATFORM.yaml`
- Auth patterns: `platforms/microsoft-ads/patterns/`
- Upstream repos: `platforms/microsoft-ads/README.md`
